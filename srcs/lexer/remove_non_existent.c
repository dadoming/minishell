...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   remove_non_existent.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: dadoming <dadoming@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/17 12:43:34 by dadoming          #+#    #+#             */
/*   Updated: 2023/03/17 12:46:17 by dadoming         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	find_in_env(int *found, t_shell *mini, char *word)
{
	...
	while (mini->core->env_p[j] != 0)
	{
		...
		if (string()->_compare_n(env_variable, word, \
			string()->_length(word)) == 0 && \
...
char	*remove_non_existent(t_shell *mini, char *content, int quote, int i)
{
	int		found;
	char	*word;
