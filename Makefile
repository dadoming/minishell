...
SRCS = srcs/signals.c srcs/evaluate.c srcs/env_utils.c srcs/prompt.c srcs/helper_print.c srcs/init.c srcs/print_error.c srcs/clear_looped_values.c \
		...
		srcs/my_lib/lst/lst2.c srcs/my_lib/lst/lst1.c srcs/my_lib/string/string_3.c srcs/my_lib/string/string_11.c srcs/my_lib/string/string_7.c \
		...
		srcs/lexer/define_type.c srcs/lexer/check_quote.c srcs/lexer/expand_env.c srcs/lexer/has_redir.c srcs/lexer/quotes.c
